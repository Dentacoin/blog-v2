...
function dcn_add_styles_and_scripts() {
    ...
    wp_enqueue_style('custom_style', get_template_directory_uri() . '-child/assets/css/style.css', array(), '1.0.7', 'all' );

    wp_enqueue_script('basic_custom_script', 'https://dentacoin.com/assets/js/basic.js', array(), '1.0.7', true);

    wp_enqueue_script('custom_script', get_template_directory_uri() . '-child/assets/js/index.js', array(), '1.0.7', true);
}
